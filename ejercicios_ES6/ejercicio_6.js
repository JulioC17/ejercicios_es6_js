...
const alumnosAprobados = exams.filter((examen) => examen.score > 5).reduce((acc, alumno) => acc + alumno.score, 0)
console.log(alumnosAprobados);


/* 6.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().  */
const media = exams.reduce((acc, suma) => acc + suma.score, 0)
const promedio = media / exams.length
